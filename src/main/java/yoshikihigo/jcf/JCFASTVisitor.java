...
public class JCFASTVisitor extends ASTVisitor {
  ...
  public JCFASTVisitor(final AST ast, final AtomicInteger pseudVariableID,
      final ASTRewrite astRewriter, final boolean aggresive, final boolean nameResolving) {
    this.ast = ast;
  ...
  public boolean visit(final ArrayAccess node) {
    ...
    Optional.ofNullable(node.getIndex())
        .ifPresent(i -> {
    ...
    Optional.ofNullable(node.getArray())
        .ifPresent(a -> {
  ...
  public boolean visit(final AssertStatement node) {
    ...
    Optional.ofNullable(node.getExpression())
        .ifPresent(e -> {
    ...
    Optional.ofNullable(node.getMessage())
        .ifPresent(m -> {
  ...
  public boolean visit(final ClassInstanceCreation node) {
    ...
    Optional.ofNullable(node.getAnonymousClassDeclaration())
  ...
  public boolean visit(final ConditionalExpression node) {
    ...
    Optional.ofNullable(node.getThenExpression())
        .ifPresent(e -> {
          if (null == this.dissolveExpression(e)) {
            e.accept(this);
          }
    ...
    Optional.ofNullable(node.getElseExpression())
        .ifPresent(e -> {
          if (null == this.dissolveExpression(e)) {
            e.accept(this);
          }
  ...
  public boolean visit(final IfStatement node) {
    ...
    Optional.ofNullable(node.getThenStatement())
        .ifPresent(e -> e.accept(this));
    Optional.ofNullable(node.getElseStatement())
        .ifPresent(e -> e.accept(this));
  ...
  public boolean visit(final InfixExpression node) {
    ...
    Optional.ofNullable(node.getLeftOperand())
        .ifPresent(e -> {
          if (null == this.dissolveExpression(e)) {
            e.accept(this);
          }
    ...
    Optional.ofNullable(node.getRightOperand())
        .ifPresent(e -> {
          if (null == this.dissolveExpression(e)) {
            e.accept(this);
          }
    ...
    Optional.ofNullable(node.extendedOperands())
        .ifPresent(e -> {
          e.stream()
              .forEach(f -> {
  ...
  public boolean visit(final PostfixExpression node) {
    ...
    Optional.ofNullable(node.getOperand())
        .ifPresent(e -> {
          if (null == this.dissolveExpression(e)) {
            e.accept(this);
          }
  ...
  private Expression dissolveExpression(final Expression expression) {
    ...
    if ((CONTEXT.NORMAL == this.context) || (CONTEXT.LOOPCONDITION == this.context)) {
      ...
      final Expression newRightExpression =
          (Expression) ASTNode.copySubtree(this.ast, targetExpression);
      fragment.setInitializer(newRightExpression);
      final VariableDeclarationStatement newStatement =
          this.ast.newVariableDeclarationStatement(fragment);
      newStatement.setType(resolvedType);
      final ListRewrite variableDeclarationInserter =
          this.astRewriter.getListRewrite(parentBlock, Block.STATEMENTS_PROPERTY);
  ...
  private void doForLoopBlock(final Statement loopStatement, final Expression expression,
    ...
    if (innerStatement instanceof Block) {
      final ListRewrite inserter =
          this.astRewriter.getListRewrite((Block) innerStatement, Block.STATEMENTS_PROPERTY);
  ...
  private Type resolveBinding(final ITypeBinding binding) {
    ...
    if (null == binding) {
      ...
      if (binding.isAnonymous()) {
        ...
        typeName = binding.getErasure()
            .getName();
      }
      Type type = null;
      if (null != packageName && !packageName.getName()
          .isEmpty()) {
      ...
      if (!binding.isParameterizedType()) {
        ...
        final ListRewrite typeArgumentsRewriter =
            this.astRewriter.getListRewrite(pType, ParameterizedType.TYPE_ARGUMENTS_PROPERTY);
